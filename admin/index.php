...
if (isset($_GET['redirect'])) {
    switch ($_GET['redirect']) {
        case "cart-order": header("Location: cart-orders.php?id=" . $_GET['order_id']); break;
        case "cart-low-stock": header("Location: cart-availability.php"); break;
        case "blog-comment": header("Location: blog.php?category=" . $_GET['category'] . "&post=" . $_POST['post']); break;
        case "guestbook-comment": header("Location: guestbook.php?post=" . $_POST['post']); break;
